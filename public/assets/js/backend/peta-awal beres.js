...
// get color depending on population density value
  ...
  function onEachFeature1(feature, layer) {
    if (feature.properties) {
          ...
          "<div class='col' id='grafik_pie1' style='border: 1px solid #999;overflow: hidden;''></div>" +
          "<div class='col' id='grafik_pie2' style='overflow: hidden; border: 1px solid #999;'></div></div></div>" +
          ...
          "<script type='text/javascript'>Highcharts.chart('grafik_pie2', {" +
          "chart: {plotBackgroundColor: null,plotBorderWidth: null,plotShadow: false," +
          "type: 'pie'},title: {text: 'ANGKATAN KERJA'},tooltip: {" +
          "pointFormat: '{series.name}: <b>{point.y} ({point.percentage:.1f}%)</b>'},plotOptions: {" +
          "pie: {allowPointSelect: true,cursor: 'pointer',dataLabels: {enabled: true," +
          "format: '<b>{point.name}</b>: {point.y} ({point.percentage:.1f}%)',style: {" +
          "color: (Highcharts.theme && Highcharts.theme.contrastTextColor) || 'black'}}}}," +
          "series: [{name: 'Angkatan Kerja',colorByPoint: true,data: [{" +
          "name: 'Belum/tidak bekerja',y: " + feature.properties.belum_tidak_bekerja + "," +
          "sliced: true,selected: true}, {name: 'Aparatur Pejabat Negara'," +
          "y: "+ feature.properties.aparatur_pejabat_negara + "}, { name: 'Pelajar dan Mahasiswa'," +
          "y: " + feature.properties.pelajar_dan_mahasiswa + "}, {name: 'Pensiunan'," +
          "y: " + feature.properties.pensiunan + "}, {name: 'Bekerja (15-64 thn)'," +
          "y: " + feature.properties.bekerja_15_64 + "}]}]});</script>";
