...
$sql = 'SELECT tb_desa_big2021_podes2020.geom, tb_spd.*, public.ST_AsGeoJSON(ST_Transform((tb_desa_big2021_podes2020.geom),4326),6) AS geojson FROM tb_desa_big2021_podes2020
INNER JOIN tb_spd ON tb_spd.kode_bps = tb_desa_big2021_podes2020.id_bps';
