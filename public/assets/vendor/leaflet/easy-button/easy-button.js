(function () {
    ...
    L.Control.EasyButton = L.Control.extend({
        ...
        initialize: function (icon, onClick, title, position, id) {
    ...
    function buildIcon(ambiguousIconString) {
        ...
        if (ambiguousIconString.match(/[&;=<>"']/)) {
            ...
            ambiguousIconString = ambiguousIconString.replace(
                /(^\s*|\s*$)/g,
                ""
            );
            tmpIcon = L.DomUtil.create("span", "");

            if (ambiguousIconString.indexOf("") === 0) {
                L.DomUtil.addClass(tmpIcon, "fa " + ambiguousIconString);
            } else if (ambiguousIconString.indexOf("glyphicon-") === 0) {
                L.DomUtil.addClass(tmpIcon, "glyphicon " + ambiguousIconString);
            } else {
                // L.DomUtil.addClass(tmpIcon, "iconify" + ambiguousIconString);
                // L.DomUtil.append(tmpIcon, "data-icon" + ambiguousIconString);
                // L.DomUtil.attr(tmpIcon, "data-target", "iconoir:3d-select-face");
                // $(tmpIcon).attr("data-target", "iconoir:3d-select-face");
