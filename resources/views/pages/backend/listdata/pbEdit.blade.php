        ...
        <div class="card-body" style="padding:2%;">
            ...
            <form action="{{ route('PbUpdate', $item->id) }}" method="post" style="padding:5%;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="jenis_usaha" class="form-control" placeholder="Jenis Usaha"
                            id="jenis_usaha" value="{{ $item->jenis_usaha }}" required>
                        @error('jenis_usaha')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="kontak_pic" class="form-control" placeholder="Kontak PIC"
                            id="kontak_pic" value="{{ $item->kontak_pic }}">
                        @error('kontak_pic')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="keterangan" class="form-control" placeholder="Keterangan"
                            id="keterangan" value="{{ $item->keterangan }}">
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="thn_bantuan" class="form-control" placeholder="Tahun Bantuan"
                            id="thn_bantuan" value="{{ $item->thn_bantuan }}" required>
                        @error('thn_bantuan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" id="alamat" class="form-control" placeholder="Alamat Lengkap">{{ $item->alamat }}</textarea>
                    @error('alamat')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="desa" class="form-control" placeholder="Desa / Kelurahan"
                            id="desa" value="{{ $item->desa }}" required>
                        @error('desa')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="kecamatan" class="form-control" placeholder="Kecamatan"
                            id="kecamatan" value="{{ $item->kecamatan }}" required>
                        @error('kecamatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="kab_kota" class="form-control" placeholder="Kabupaten / Kota"
                            id="kab_kota" value="{{ $item->kab_kota }}" required>
                        @error('kab_kota')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="provinsi" class="form-control" placeholder="Provinsi"
                            id="provinsi" value="{{ $item->provinsi }}" required>
                        @error('provinsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="longitude"
                            ...
                            placeholder="tambah koordinat atau geser marker peta" id="longitude"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="latitude"
                            ...
                            placeholder="tambah koordinat atau geser marker peta" id="latitude"
...
@section('addon-script')
    ...
    <script>
        ...
        var curLocation = [{{ $item->latitude }}, {{ $item->longitude }}];
