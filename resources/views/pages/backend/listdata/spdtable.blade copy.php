        ...
        <div class="card col-md-12">
            ...
            <div class="card-body" style="padding:2%;">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <p>Jumlah <b>{{ number_format($spd_total) }}</b></p>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-center text-xxs font-weight-bolder">Tahun Survey</th>
                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td class="align-middle text-center"><span>{{ $item->spd_thn_survey }}</span></td>

                                    @if (Auth::user()->roles == 'ADMIN')
                                        <td class="align-middle text-center">
                                            {{-- <a href="{{ route('SpdShow', $item->id) }}"
                                            ...
                                            <form action="{{ route('SpdDestroy', $item->kode_bps) }}" method="post"
