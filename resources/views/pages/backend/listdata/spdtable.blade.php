...
@section('addon-script')
    ...
    <script>
        ShowTabel('spd-data', 'tabel-spd');
        ShowTabel('spd-data-2', 'tabel-spd-2');
        ShowTabel('spd-data-3', 'tabel-spd-3');

        function ShowTabel(jenis, idhtml) {
            if (jenis == "spd-data") {
                var nmfield = nmField_spd;
                var url = base_url + "/ShowTabelSPD";
                var value = true
            } else if (jenis == "spd-data-2") {
                var nmfield = nmField_spd_2;
                var url = base_url + "/ShowTabelSPD";
                var value = false
            } else if (jenis == "spd-data-3") {
                var nmfield = nmField_spd_3;
                var url = base_url + "/ShowTabelSPD";
                var value = false
            } else {}
            $.ajax({
