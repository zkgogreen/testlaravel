...
@section('addon-script')
    ...
    <script>
        ShowTabel('podes20-data', 'tabel-podes20');
        // ShowTabel_dua('spd-data-2', 'tabel-spd-2');

        function ShowTabel(jenis, idhtml) {
            if (jenis == "podes20-data") {
                var nmfield = nmField_podes20;
                var url = base_url + "/ShowTabelPodes20";
            } else {}
            $.ajax({
                type: "get",
                url: url,
