...
{{-- <script src="{{ url('assets/vendor/bootstrap-table-master/dist/extensions/key-events/bootstrap-table-key-events.min.js') }}"></script> --}}
...
<script type="text/javascript" src="{{ url('assets/leaflet/humangeo-leaflet-dvf-79aba9f/examples/lib/jsts/jsts.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/leaflet/humangeo-leaflet-dvf-79aba9f/examples/lib/date.format.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/leaflet/humangeo-leaflet-dvf-79aba9f/examples/lib/geohash.js') }}"></script>
<script type="text/javascript" src="{{ url('assets/leaflet/humangeo-leaflet-dvf-79aba9f/dist/leaflet-dvf.js') }}"></script>	 --}}
